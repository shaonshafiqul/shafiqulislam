...
description = "Let's bring your ideas to life and create something amazing together.",
...
className="relative max-w-5xl mx-auto rounded-[2rem] overflow-hidden border border-white/10"
>
{/* Glass Background */}
<div className="absolute inset-0 bg-white/[0.02] backdrop-blur-3xl" />
    ...
    {/* Blue Ambient Glow */}
    <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-blue-900/20 blur-[120px] rounded-full animate-pulse" />

    {/* Purple Ambient Glow */}
    <div className="absolute bottom-0 right-0 w-[400px] h-[400px] bg-purple-900/20 blur-[100px] rounded-full opacity-50" />
