      ...
      >
        <div className="w-full flex items-center justify-between">
          <Link href="/" className="flex items-center space-x-3 group">
            <div
              className={`p-2 rounded-lg transition-all duration-300 ${scrolled ? "bg-white/5 group-hover:bg-blue-600" : "bg-white/10 group-hover:bg-blue-600"}`}
            >
              <Clapperboard />
            </div>
            ...
            <div className="flex items-center space-x-1">
              {navItems.map((item) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={`relative z-10 ${isActive ? "text-white" : "text-gray-400 group-hover:text-white"}`}
                    >
                      {item.name}
                    </span>
